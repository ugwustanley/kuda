...
const OrgDash = () => {
    ...
    return (
        <div className="OrgDash">
            <div className={ show === true ? `nav__show OrgDash__nav` : `nav__hide OrgDash__nav`}>
            <div className="OrgDash__cancel">
            ...
            <div className={ show === true ? `nav__showing OrgDash__body` : `nav__hiding OrgDash__body`}>
                   <div className="OrgDash__menu" onClick={() => setShow(!show)}>
